...
.EXAMPLE
Remove-Deployment -DeploymentName 'KeyVault' -ResourceGroupName 'epocarmldemo-validation-rg' -TemplateFilePath 'C:/deploy.json'

Remove a virtual WAN with deployment name 'keyvault-12345' from resource group 'epocarmldemo-validation-rg'
#>
