...
.EXAMPLE
Publish-ModuleToTemplateSpec -TemplateFilePath 'C:\arm\Microsoft.KeyVault\vaults\deploy.bicep' -ModuleVersion '3.0.0-alpha' -TemplateSpecsRgName 'epocarmldemo-artifacts-rg' -TemplateSpecsRgLocation 'West Europe' -TemplateSpecsDescription 'iacs key vault'

Try to publish the KeyVault module with version 3.0.0-alpha to a template spec in resource group 'epocarmldemo-artifacts-rg'.
#>
